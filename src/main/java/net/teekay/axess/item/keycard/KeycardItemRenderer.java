    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext ctx, PoseStack ps,
        ...
        for (var quad : model.getQuads(null, null, rS)) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                display.addVertex(mat, x, y, z)
                        .setColor(keycardColor.getRed(), keycardColor.getGreen(), keycardColor.getBlue(), 255)
                        .setUv(u, v)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(LightTexture.FULL_BRIGHT)
                        .setNormal(ps.last(), quad.getDirection().getStepX(), quad.getDirection().getStepY(), quad.getDirection().getStepZ());
            }
        }
