...
public class MiniKeycardReaderLeftBlock extends AbstractKeycardReaderBlock {
    ...
    public MiniKeycardReaderLeftBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    @Override
    protected com.mojang.serialization.MapCodec<MiniKeycardReaderLeftBlock> codec() {
        return BlockBehaviour.simpleCodec(properties -> new MiniKeycardReaderLeftBlock(properties));
    }
