...
public class MiniKeycardReaderRightBlock extends AbstractKeycardReaderBlock {
    ...
    public MiniKeycardReaderRightBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    @Override
    protected com.mojang.serialization.MapCodec<MiniKeycardReaderRightBlock> codec() {
        return BlockBehaviour.simpleCodec(properties -> new MiniKeycardReaderRightBlock(properties));
    }
