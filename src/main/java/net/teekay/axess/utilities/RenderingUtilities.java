...
public class RenderingUtilities {
    public static void renderLine(PoseStack poseStack, MultiBufferSource buffer, BlockPos bp1, BlockPos bp2, Vec3 offset1, Vec3 offset2, Color color) {
        ...
        consumer.addVertex(matrix, (float) offset1.x + a.getX(), (float) offset1.y + a.getY(), (float) offset1.z + a.getZ())
                .setColor(color.getRed(), color.getGreen(), color.getBlue(), 255);
        consumer.addVertex(matrix, (float) offset2.x + b.getX(), (float) offset2.y + b.getY(), (float) offset2.z + b.getZ())
                .setColor(color.getRed(), color.getGreen(), color.getBlue(), 255);
    }
