...
public class NetworkManagerScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        // Screen.render() calls renderBackground() before drawing the widgets.
        // The vanilla implementation applies the 1.21.1 blur here, which would
        // also blur the Network Manager GUI. Keep only the dark overlay.
        pGuiGraphics.fill(0, 0, this.width, this.height, 0x99000000);
    }
    ...
    @Override
    public boolean mouseScrolled(double pMouseX, double pMouseY, double pDeltaX, double pDelta) {
        this.networkList.scroll((int) (pDelta) * -7);
        return super.mouseScrolled(pMouseX, pMouseY, pDeltaX, pDelta);
    }
}
