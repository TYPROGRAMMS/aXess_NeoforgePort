...
public class NetworkEditorScreen extends Screen {
    ...
    public void renderBackground(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        // Do not use Screen's default blurred background for the editor.
        // In 1.21.1 the blur pass can bleed translucent GUI pixels into
        // controls and produces the horizontal artefacts seen on this screen.
